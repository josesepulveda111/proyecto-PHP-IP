...
<section class="section pb-0">
   <div class="container">
      <h2 class="section-title">Supermercados
      </h2>
      <div class="columns is-multiline">
         ...
         <div class="column is-3-widescreen is-4-desktop is-6-tablet">
            <div class="card match-height">
               <div class="card-body">
                  <img class="imagen-card" src="img/surtimax.png" alt="">
                  <br><br>
                  <h3 class="card-title h4">Surtimax</h3>
                  <p class="card-text">Cl. 49 #33 - 49, Medellín</p>
                  <p class="card-text">305 3609899</p>
               </div>
            </div>
         </div>
         ...
         <div class="column is-3-widescreen is-4-desktop is-6-tablet">
            <div class="card match-height">
               <div class="card-body">
                  <img class="imagen-card" src="img/Olimpica.png" alt="">
                  <br><br>
                  <h3 class="card-title h4">Olimpica</h3>
                  <p class="card-text"> Cra. 30 #41 - 35, Medellín</p>
                  <p class="card-text">01 8000 510 510</p>
               </div>
            </div>
         </div>
         ...
         <div class="column is-3-widescreen is-4-desktop is-6-tablet">
            <div class="card match-height">
               <div class="card-body">
                  <img class="imagen-card" src="img/d1.png" alt="">
                  <br><br>
                  <h3 class="card-title h4">Tiendas D1</h3>
                  <p class="card-text">Cl. 46 #29-60, Medellín</p>
                  <p class="card-text">01 8000 120201</p>
               </div>
            </div>
         </div>
         ...
         <div class="column is-3-widescreen is-4-desktop is-6-tablet">
            <div class="card match-height">
               <div class="card-body">
                  <img class="imagen-card" src="img/ara.jpg" alt="">
                  <br><br>
                  <h3 class="card-title h4">Tiendas Ara</h3>
                  <p class="card-text">Cl. 54 #38-19, Medellín</p>
                  <p class="card-text">(604) 4477124</p>
                  <!-- <a href="h" class="stretched-link"></a> -->
               </div>
            </div>
         </div>
